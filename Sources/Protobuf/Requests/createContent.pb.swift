...
// Source: Requests/createContent.proto
//
...
extension CreateContent: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

extension CreateContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "CreateContent"
  ...
  public static func ==(lhs: CreateContent, rhs: CreateContent) -> Bool {
